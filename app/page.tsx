                ...
                <div className=" flex flex-col max-w-[800px] w-full rounded-2xl py-2 bg-white h-fit duration-300 transition-all  " >
                    <SearchBar status={status} setData={setData} setStatus={setStatus} setSearchParms={setSearchParms} searchParms={searchParms} />
                    {
                        status === "loading" ? (
                            ...
                            <div className=" w-full flex flex-col gap-4 p-4 overflow-y-scroll max-h-[800px] " >
                                <PersonelModal isModalVisible={isPersonelModalVisible} data={personelData} setIsModalVisible={setIsPersonelModalVisible} title="Personel Modal"/>
                                {
