...
export default function Home() {
    ...
    return (
        <div className=" flex flex-col items-center justify-between gap-[30px] w-full min-h-[100dvh] ">
        <div className=" flex flex-col items-center sm:pt-[80px] px-[20px] pb-5 gap-8 w-full max-w-[800px] h-fit 0 " >
            <Header/>
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                ...
                                <p className=" capitalize text-black ">{`${item} Information `} 
