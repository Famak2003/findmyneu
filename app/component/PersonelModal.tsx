                        ...
                        <div className=" skeletonModal ">
                            ...
                            <div className=" flex flex-col gap-1 w-full text-black ">
                                <div className=" flex flex-col gap-2 px-3   ">
                                    <h1 className=" font-bold text-lg ">{fetchedData?.name} {fetchedData?.surname}</h1>
                                </div>
                                <div className="flex flex-col gap-1 p-3 w-full h-full text-black text-[14px] bg-opacity-30 bg-light-silvergray rounded-lg ">
                                    <div className=" flex gap-2 ">
                                        <h2 className=" font-semibold  ">Email</h2> : <p className="overflow-x-clip w-[70%] sm:w-full">{fetchedData?.EmployeeOfficial?.companyEmail || "..."} </p> 
                                    </div>
                                    <div className=" flex gap-2 ">
                                        <h2 className=" font-semibold ">Position</h2> : <p>{fetchedData?.EmployeeOfficial?.Position?.name_en || "..."} </p> 
                                    </div>
                                    <div className=" flex gap-2 ">
                                        <h2 className=" font-semibold ">Office</h2> : <p> {fetchedData?.EmployeeOfficial?.Branch?.name || "..."} {">"} {fetchedData?.EmployeeOfficial?.Office?.name || "..."} </p>
                                    </div>
                                </div>
                                {/* <div className=" flex gap-2 ">
